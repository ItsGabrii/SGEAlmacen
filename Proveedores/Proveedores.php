<?php
    if (isset($_POST['enviar'])){
        ...
        $instruccionInsert = "INSERT INTO proveedor (nombre, cif, direccion, telefono, contacto) VALUES ('$nombre', '$cif', '$direccion', '$telefono', '$contacto')";
        ...
        $instruccionSelect = "SELECT * FROM proveedor WHERE id_proveedor = $ultimo_id";
...
<body>
    ...
    <div class='contenedor-botones-superior'>
        <br><a href='../Productos/MenuAlmacen.php' class='boton-menu'>Menu Almacén</a>
    </div>
    <div id = "formulario">
