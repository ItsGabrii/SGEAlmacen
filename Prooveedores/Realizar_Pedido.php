...
if (isset($_POST['ejecutar_update'])) {
    ...
    $sql_update = "UPDATE producto SET cantidad = cantidad + $unidades WHERE id_producto = '$id_prod'";
    ...
    <div id="formulario">
        ...
        <form method="post" action="Realizar_Pedido.php">
            ...
            <select name="producto_elegido" style="width:100%; padding:10px; margin-bottom:18px;">
                ...
                $sql_productos = "SELECT id_producto FROM producto_proveedor WHERE id_proveedor = '$id_prov'";
                ...
                if(mysqli_num_rows($res) > 0){
                    while ($fila = mysqli_fetch_array($res)) {
                        ...
                        $sql_nombre = "SELECT nombre FROM producto WHERE id_producto = '$id_p'";
                        $res_nombre = mysqli_query($conexion,$sql_nombre);
                        $fila_prod = mysqli_fetch_array($res_nombre);


                        echo "<option value='".$id_p."'>".$fila_prod['nombre']."($id_p)</option>";
                    }                               
                } else {
                    echo "<option value=''>Este proveedor no tiene productos asociados</option>";
                }
...
<?php 
    ...
    print"No se ha encontrado el proveedor correctamente";
}
